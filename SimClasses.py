...
class Entity():
    ...
    def __init__(self):
        ...
        self.PatientClass = None # add the patient class Triage 1,2,3; IP 1,2,3
        self.Deadline = 0.0 # add the deadline for the triage patients
        self.DTimeUnits = 0.0
...
class FIFOQueue():
    ...
    def Insert(self,X,ind): # new function
        # Insert an entity to the index position of the queue
        self.ThisQueue.insert(ind,X)
        numqueue = self.NumQueue()
        self.WIP.Record(float(numqueue))  
